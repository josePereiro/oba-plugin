...
import { backends, callbacks, commands, dev, git, markerpdf, mdjson, obanotes, obauri, pdfrepo, replacer, scihub, statusbar, tagnotices, vscode } from './services-base/0-servises-modules';
